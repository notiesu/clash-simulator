...
TIMESTEPS_DONE = 0
NUM_ENVS_TRAINING = 1 #CPU DEBUGGING
NUM_ENVS_EVAL = 1 #CPU DEBUGGING
N_STEPS = 1024
BATCH_SIZE = 512
...
OPPONENT = ReplayInferenceModel(ClashRoyaleGymEnv(), replay_path="exampletrain/replay_opponent.jsonl")
OPPONENT_POLICIES = [
